...
static uint64_t tegra241_cmdqv_read_mmio(void *opaque, hwaddr offset, unsigned size)
{
    return 0;
}

static void tegra241_cmdqv_write_mmio(void *opaque, hwaddr offset, uint64_t value,
                                 unsigned size)
{
}
